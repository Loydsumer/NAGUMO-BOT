    ...
    if (lister.includes(feature)) {
        ...
        if (feature == "تحميل") {
            ...
            try {
                ...
                await conn.sendFile(m.chat, data, pdfTitle, "تم تحميل المانجا بواسطة عائلة بوت بنجاح 💛", m, null, {
