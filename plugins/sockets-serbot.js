...
let rtx2 = "*~⧼❆˹─━═┉⌯⤸◞🧭◜⤹⌯┉═━─˼‏❆⧽~*\n" +
"*🧭┊⪼• ◈╷SER BOT ⥏🧭⥑ 𝑴𝑶𝑫𝑬 𝑪𝑶𝑫𝑬╵◈*\n" +
"*¦ ⌗╎تـحـويـل حـسـابـك لـSub-Bot ⌗ ¦*\n\n" +
"*~˼‏※⸃─┉┈┈⥏🧭⥑┈┈┉─⸂※ ˹~*\n" +
"*⸂┊˼‏الـخـطـوات لـتـشـغـيل الـبـوت ¦↓⸃*\n" +
"> *`1` » اضغط على الثلاث نقاط في أعلى اليمين*\n" +
"> *`2` » اختـر أجهزة متصلة*\n" +
"> *`3` » اختـر ربط مع رقم الهاتف*\n" +
"> *`4` » أدخـل الكود لتسجيل الدخول مع البوت*\n\n" +
"*~˼‏※⸃─┉┈┈⥏🧭⥑┈┈┉─⸂※ ˹~*\n" +
"*⸂┊˼‏مـلاحـظـات ¦↓⸃*\n" +
"> *✧ لا ينصح باستخدام حسابك الرئيسي*\n\n" +
"*~⧼❆˹─━═┉⌯⤸◞🧭◜⤹⌯┉═━─˼‏❆⧽~*";
...
if (!globalThis.db.data.settings[conn.user.jid].jadibotmd) return m.reply(`⸂🍓┊˼‏ الـأمـر ${command} مـعـطـل مؤقـتـاً.⸃`)

let time = global.db.data.users[m.sender].Subs + 120000

if (new Date - global.db.data.users[m.sender].Subs < 120000) return conn.reply(m.chat, `⸂🍓┊˼‏يـجـب أن تـنـتـظـر ${msToTime(time - new Date())} لـلـعـودة.⸃`, m)

let socklimit = global.conns.filter(sock => sock?.user).length

if (socklimit >= 50) {

return m.reply(`ꕥ لم يتم العثور على أي مساحات متاحة لـ *Sub-Bots*.`)
