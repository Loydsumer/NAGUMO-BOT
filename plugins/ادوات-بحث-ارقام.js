let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    if (array.length === 0) return m.reply('🧞‍♀️ لم يتم العثور على أرقام مسجلة على واتساب!');
    
    let txt = '🧞‍♀️ • *الأرقام المسجلة على واتساب:*\n\n' + array
